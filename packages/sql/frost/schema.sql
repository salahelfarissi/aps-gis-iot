...
AFTER DELETE ON "OBSERVATIONS_TS" FOR EACH ROW EXECUTE FUNCTION datastreams_update_delete();
CREATE TRIGGER datastreams_actualization_insert
AFTER
INSERT ON "OBSERVATIONS_TS" FOR EACH ROW EXECUTE FUNCTION datastreams_update_insert();
CREATE TRIGGER datastreams_actualization_update
AFTER
UPDATE ON "OBSERVATIONS_TS" FOR EACH ROW EXECUTE FUNCTION datastreams_update_update();
CREATE TRIGGER multidatastreams_actualization_delete
AFTER DELETE ON "OBSERVATIONS_TS" FOR EACH ROW EXECUTE FUNCTION multidatastreams_update_delete();
CREATE TRIGGER multidatastreams_actualization_insert
AFTER
INSERT ON "OBSERVATIONS_TS" FOR EACH ROW EXECUTE FUNCTION multidatastreams_update_insert();
CREATE TRIGGER multidatastreams_actualization_update
AFTER
UPDATE ON "OBSERVATIONS_TS" FOR EACH ROW EXECUTE FUNCTION multidatastreams_update_update();